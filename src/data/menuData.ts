...
export const defaultRobotItems: MenuItem[] = [
  ...
  // Hot → Chocolate (ژێر-کاتەگۆری: شکلاتە)
...
export const defaultStaffItems: MenuItem[] = [
  // Sandwich → Chicken (ژێر-کاتەگۆری: مریشک)
  ...
  // Sandwich → Beef (ژێر-کاتەگۆری: گۆشت)
  ...
  // Dessert → Pastry (ژێر-کاتەگۆری: پەستری)
